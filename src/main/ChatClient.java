        ...
        try {
            ...
            sendButton.setOnAction(e -> {
                ...
                if (!username.isEmpty() && !message.isEmpty()) {
                    ...
                    textField.clear();
                    System.out.println("** DEBUG: Sent message: " + username + ": " + message); // Debugging message
                } else {
                    // Notify the user to enter both username and message
                ...
                try {
                    while (true) {
                        ...
                        Platform.runLater(() -> {
                            ...
                            System.out.println("** DEBUG: Received message: " + message); // Debugging message
                        });
                    }
                } catch (IOException e) {
                    e.printStackTrace();
